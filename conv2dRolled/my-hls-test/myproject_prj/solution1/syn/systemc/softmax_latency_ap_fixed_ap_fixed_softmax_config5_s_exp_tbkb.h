...
// ==============================================================
#ifndef __softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_H__
#define __softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_H__
...
struct softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_ram) {
...
SC_MODULE(softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb) {
...
softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_ram* meminst;


SC_CTOR(softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb) {
meminst = new softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_ram("softmax_latency_ap_fixed_ap_fixed_softmax_config5_s_exp_tbkb_ram");
