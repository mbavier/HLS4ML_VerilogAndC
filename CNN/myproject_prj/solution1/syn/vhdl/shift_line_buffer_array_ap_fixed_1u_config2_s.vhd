...
architecture behav of shift_line_buffer_array_ap_fixed_1u_config2_s is 
    ...
    signal line_buffer_Array_V_1_0_q0 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    line_buffer_Array_V_1_0_U : component shift_line_buffer_array_ap_fixed_1u_config2_s_line_bufferbkb
    generic map (
        DataWidth => 16,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    ap_return_4 <= line_buffer_Array_V_1_0_q0;
    ...
    line_buffer_Array_V_1_0_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    line_buffer_Array_V_1_0_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
