...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom (
...
initial begin
    $readmemh("./softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom.dat", ram0);
    $readmemh("./softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom.dat", ram1);
    $readmemh("./softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom.dat", ram2);
    $readmemh("./softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom.dat", ram3);
    $readmemh("./softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe(
    reset,
    clk,
    address0,
    ce0,
...
softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom softmax_stable_array_array_ap_fixed_10u_softmax_config6_sdEe_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
